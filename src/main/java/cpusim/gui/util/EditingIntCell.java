 ...
 * It accepts any integer (positive or negative).
 */
...
public class EditingIntCell<T> extends TableCell<T, Integer> {
    ...
    public void updateItem(Integer item, boolean empty) {
        ...
        if (empty) {
            ...
            setText(getString());
            setGraphic(null);
            setTooltip(new Tooltip("Binary: " + Integer.toBinaryString(item) +
    ...
    private void createTextField() {
        ...
        textField.focusedProperty().addListener((arg0, arg1, arg2) -> {
            ...
            if (!arg2) { // focus moved away from this field
                try {
                    int newInteger = (int) Convert.fromAnyBaseStringToLong(textField.getText());
                    commitEdit(newInteger);
