...
public class MachineReader
    ...
    public void startMachine(Attributes alAttrs) {
        ...
        machine = new Machine(name, true); //has default set of fields
...
//        channels.clear();
    ...
    public void startTransferRtoA(Attributes attrs) {
        ...
        TransferRtoA c =
                new TransferRtoA(name, machine, source, srcStartBit, dest, destStartBit,
    ...
    public void startTransferAtoR(Attributes attrs) {
        ...
        TransferAtoR c = new TransferAtoR(name, machine, source, srcStartBit,
    ...
    public void startTest(Attributes attrs) {
        ...
        Test c = new Test(name, machine, register, start, numBits, comparison, Long.valueOf(value),
                omission);
        String id = attrs.getValue("id");
        components.put(id, c);
...
//        }
    ...
    public void startIndexingInfo(Attributes attrs){
        ...
        if (indexFromRightString.equals("true")){
            ...
            throw new MachineReaderException(
                    getCurrentLine() + "The indexFromRight property must be either "
