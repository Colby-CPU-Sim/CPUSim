...
public abstract class MoreBindings {
    ...
    /**
     * Converts an {@link ObservableList ObservableList<T>}  to a one dimensional
     ...
     * sorted by the name of the {@code <T>}.
     *
     * @param input List of values to map
     * @param mapper Function to map to a List of other values
     * @param <T> Input type
     * @param <R> Output type
     * @return Single dimensional {@code ObservableList} mapped to the input values.
     */
     ...
     *
     * @param input List of values concatenate
     * @param <T> Input type
